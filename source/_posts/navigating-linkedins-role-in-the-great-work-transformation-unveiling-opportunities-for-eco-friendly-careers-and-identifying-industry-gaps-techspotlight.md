...
## Navigating LinkedIn's Role in The Great Work Transformation: Unveiling Opportunities for Eco-Friendly Careers & Identifying Industry Gaps | TechSpotlight

![economicgraph-linkedin-com.png](https://www.zdnet.com/a/img/resize/e27c39aa369d02d2956a7a85a1b78d38e9b2aecf/2022/04/13/be0c4141-1a88-40fa-88a7-4dd9f234463c/economicgraph-linkedin-com.png?auto=webp&width=1280)
...
The "Great Resignation" is making the headlines, but LinkedIn and the _World Economic Forum_ argue it's all part of the "[Great Reshuffle](https://www.weforum.org/agenda/2022/02/great-reshuffle-jobs-market-resignation/)" -- a time when everyone is rethinking everything. The term first aired in 2021 and has been making the rounds since.

LinkedIn purports that the [Great Reshuffle](https://www.linkedin.com/pulse/navigating-great-reshuffle-ryan-roslansky/) presents a unique opportunity to tackle humanity's most urgent challenge: climate change. We have to enable the green transition and activate the jobs, companies and policies that power it, but there are a number of challenges associated with that.

### More Education

* [Back to school: The top deals on essential tech for students](https://www.zdnet.com/collection/back-to-school/)
* [Our favorite free online tech courses with certificates](https://www.zdnet.com/article/free-online-certificate-courses/)
* [The pandemic's surprising impact on K-12 computer science education](https://www.zdnet.com/article/pandemic-impact-k-12-computer-science-education/)
* [The best information technology bootcamps](https://www.zdnet.com/article/information-technology-bootcamps/)
* [No diploma? Here are 5 tech jobs you can hold with no degree](https://www.zdnet.com/article/tech-jobs-no-degree/)
...
But it's more than jobs, Roslansky thinks -- we need to zoom in on the skills that power these jobs. LinkedIn's take is that real change will come through a skills-based approach to opportunity, emphasizing what it calls [green skills](https://www.zdnet.com/home-and-office/sustainability/want-to-attract-new-tech-talent-start-thinking-green/): skills that enable the environmental sustainability of economic activities.
...
**Also: [2022 technology trend review, part one: Open source, cloud, blockchain](https://www.zdnet.com/article/2022-technology-trend-review-part-one-open-source-cloud-blockchain/)**
...
**Also: [2022 technology trend review, part two: AI and graphs](https://www.zdnet.com/article/2022-technology-trend-review-part-two-ai-and-graphs/)**
...
As former Technical Lead for Taxonomies and Ontologies, AI Division at LinkedIn, [Mike Dillinger notes that taxonomies are the duct tape of connected data](https://2021.connecteddataworld.com/talks/mike-dillinger-taxonomies-connecting-data-with-duct-tape/). They seem simple, flexible, and familiar. They are widely used. And they seem to work across many use cases and many domains. 
...
Perhaps more importantly, taxonomies, like any other knowledge organization approach, represent a subjective and imperfect way to look at the world. Case in point -- [the European Commission has recently published its own taxonomy of skills for the green transition](https://ec.europa.eu/newsroom/empl/items/741088/en) in European Skills, Competences, Qualifications and Occupations (ESCO).
...
* [The top home EV chargers: Easily fuel up your car](https://www.zdnet.com/article/best-home-ev-charger/)
* [EV ownership is neither fairytale nor nightmare](https://www.zdnet.com/article/ev-ownership-is-neither-fairytale-nor-nightmare/)
* [Our favorite electric lawn mowers: The best alternatives to gas-powered](https://www.zdnet.com/article/best-electric-mower/)
...
But even more alarmingly - are we sure that these are actually green skills? It may sound counter-intuitive, but the extent to which electric cars are actually green is not entirely clear. That is according to an [analysis done by Volvo, a European car manufacturer](https://www.carscoops.com/2021/11/volvo-says-manufacturing-an-electric-car-generates-70-percent-more-emissions-than-its-petrol-equivalent/).
